...
c. Facet each parks, and create a 
```{r}
```{r}
ggplot(pdx_precip_snow, aes(x = date, y = value, color = datatype )) +
  geom_point()+
  geom_smooth()+
  labs(title = "Precipiation and Snowfall data for 2021", x = "Dates", y = "Amount Fell (mm)", color = "Type")+
